...
WIKI_SIDEBAR_SYSTEM_PROMPT: str = (
    ...
    "MANDATORY NODES (always first two, in this order):\n"
    ...
    "No children.\n"
    "2. 'Architecture' — second node. Set page_title to the ARCH_CANDIDATE page title "
    "provided in the input (or the most system-design/structure page). No children.\n\n"
    "NAMING RULES:\n"
